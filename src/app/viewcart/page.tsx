...
import Navbar from "../shop/Navbar"; // Importing Navbar component
import Image from "next/image"; // Importing Next.js Image component for optimized images
import { AiOutlineRight } from "react-icons/ai"; // Importing icon for right arrow navigation
import Return from "../shop/Return"; // Importing the Delivery/Return info section
  ...
  return (
    <div>
      ...
      <div className="relative w-full">
        {/* Background Image */}
        <Image
          src={"/Rectangle 1.png"} // Path to background image
          alt="Hero Background"
          objectFit="cover"
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white">
          {/* Logo Image */}
          <Image
            src={"/Meubel House_Logos-05.png"} // Path to logo image
            alt=""
            width={90}
            height={90}
      ...
      <div className="flex justify-center py-10">
        <div className="w-full md:max-w-6xl flex flex-col justify-center items-center md:flex-row">
          ...
          {/* Product Table - Contains product details such as name, price, and quantity */}
          <div className="flex-grow bg-white md:p-6 w-[80%]">
            <table className="md:w-full">
              <thead>
                {/* Table headers for Product, Price, Quantity, and Subtotal */}
              ...
              <tbody>
                {/* Product Row - Displays the product image, name, price, quantity, and subtotal */}
                <tr>
