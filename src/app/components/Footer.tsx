...
// Footer Component: Contains the footer content for the website
    ...
    <footer className="bg-white pt-20 px-6 md:px-20">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="flex flex-col text-center md:text-start md:relative md:left-20">
          <h3 className="text-[16px] text-[#9F9F9F]  hover:text-gray-800font-medium mb-4 md:text-start">Links</h3>
        ...
        <div className="flex flex-col items-center text-center md:items-start">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-stretch mt-4 w-full">
            <input
              ...
              className="w-full sm:flex-1 border-b border-black py-1 focus:ring-0 focus:outline-none placeholder:text-[#9F9F9F] placeholder:text-[12px] text-sm"
            />
            <button className="mt-4 sm:mt-0 sm:ml-4 py-2 px-3 text-black hover:text-gray-300 font-medium text-[14px] underline underline-offset-[12px]">
              SUBSCRIBE
            </button>
          </div>
        </div>
